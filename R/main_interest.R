...
# assess rules for interestingness; provide function with datanames, rules and class labels
ob_kyphosis <- objective_interest("Kyphsosis",rules_kyphosis,kyphosis$Kyphosis)
ob_titanic <- objective_interest("Titanic",rules_titanic,ptitanic$survived)
